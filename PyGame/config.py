...
magic_bomb_img = pygame.image.load('PyGame\imgs\player\Projectiles\Magic_Bomb\magic_bomb_img.png').convert_alpha()
...
class Explosion_Class(pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        self.images = []
        for i in range(1, 7):
            expl_imgs = pygame.image.load(f'PyGame\imgs\player\Projectiles\Magic_Bomb\Explosion Animation\__{i}.png').convert_alpha()
...
player = Hero('player',200, 200, 1, 6, 20, 100, 100)
